...
from socialcommons.file_manager import get_chromedriver_location
...
def set_selenium_local_session(proxy_address,
    ...
    if use_firefox:
        ...
        browser = webdriver.Firefox(firefox_profile=firefox_profile, firefox_options=firefox_options)
    else:
